# 8.XStream包混叠 - XStream教程
包装混叠用于创建一个类XML的完全限定名称的别名到一个新的限定名称。再次修改我们的例子中并更改以下代码。
...
创建一个Java类名为 XStreamTester 文件在 C:\\>XStream_WORKSPACE\\com\\yiibai\\xstream.
...
```
<?xml version="1.0" encoding="UTF-8"?>  <my.company.xstream.Student  name="Mahesh">  <my.company.xstream.Note>  <title>first</title>  <description>My first assignment.</description>  </my.company.xstream.Note>  <my.company.xstream.Note>  <title>second</title>  <description>My Second assignment.</description>  </my.company.xstream.Note>  </my.company.xstream.Student>
```